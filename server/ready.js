...
module.exports = (client) => {
    ...
    client.on('voiceStateUpdate', (oldMember, newMember) => {
        if (isLeave(oldMember, newMember)) client.servers[oldMember.guild.id].emit('leave', oldMember);
        if (isEnter(oldMember, newMember)) client.servers[newMember.guild.id].emit('enter', newMember);
        if (isChange(oldMember, newMember)) client.servers[newMember.guild.id].emit('change', oldMember, newMember);
    })
